                                ...
                                @foreach ($products as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="vertical-align:middle"><a
                                                href="{{ route('front.product', $product->slug) }}" target="_blank">{{ $product->title }}</a></td>
                                        <td class="text-center" style="vertical-align:middle">
                                            {{ number_format($product->price, 2, ',', '.') }} €</td>
                                        <td class="text-center" style="vertical-align:middle">{{ $product->qty }} left in
                                            stock</td>
                                        <td class="text-center" style="vertical-align:middle">{{ $product->sku }}</td>
                                        <td class="text-center" style="vertical-align:middle">
                                            @if ($product->status == 1)
