                    ...
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="vertical-align:middle" width="100">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($subCategories->isNotEmpty())
                                @foreach ($subCategories as $subCategory)
                                    <tr>
                                        ...
                                        <td class="text-center" style="vertical-align:middle">{{ $subCategory->name }}</td>
                                        <td class="text-center" style="vertical-align:middle">{{ $subCategory->slug }}</td>
                                        <td class="text-center" style="vertical-align:middle">
                                            {{ $subCategory->categoryName }}</td>
                                        <td class="text-center" style="vertical-align:middle">
