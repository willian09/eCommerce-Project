                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="card-body">
                                @foreach (Cart::content() as $item)
                                    <div class="d-flex justify-content-between pb-2">
                                        ...
                                        <div class="h6">{{ number_format($item->price * $item->qty, 2, ',', '.') }} €
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="d-flex justify-content-between summery-end">
                                    ...
                                    <div class="h6" style="color:red">
                                        <strong id="discount_value">{{ number_format($discount, 2, ',', '.') }} €</strong>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="h6">
                                        <strong id="shippingAmount">{{ number_format($totalShippingCharge, 2, ',', '.') }}
                                            €</strong>
                                    </div>
                                </div>
                        ...
                        <div class="card payment-form ">
                            <h3 class="card-title h5 mb-3">Apply Discount Coupon</h3>
                            <div class="input-group apply-coupan mt-2">
                                <input type="text" placeholder="Coupon Code" class="form-control"
                                    name="discount_code" id="discount_code">
                            </div>
                            <div id="discount-div-wrapper">
                                @if (Session::has('code'))
                                    <div class="mt-4" id="discount-div">
                            ...
                            <div class="input-group apply-coupan mt-4">
                                <button class="btn btn-dark btn-block w-100" type="button" id="apply-discount">Apply
                                    Coupon</button>
                            </div>
                        </div>
                        <div class="card payment-form ">
                            ...
                            <div class="card-body p-0 d-none" id="card-payment-form">
                                <div class="mb-3">
                                    <label for="card_number" class="mb-2 mt-2">Card Number</label>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        $("#discount-div-wrapper").html(response.discountString);
                        $("#discount_code").val('');
                    } else {
                        $("#discount-div-wrapper").html("<span class='text-danger'>" + response
                            .message + "</span>");
