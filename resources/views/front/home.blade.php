            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <picture>
                        ...
                        <source media="(max-width: 800px)" srcset="{{ asset('front-assets/images/carousel-1.jpg') }}" />
                ...
                <div class="carousel-item">
                    <picture>
                        ...
                        <source media="(max-width: 800px)" srcset="{{ asset('front-assets/images/carousel-2.jpg') }}" />
                ...
                <div class="carousel-item">
                    <picture>
                        ...
                        <source media="(max-width: 800px)" srcset="{{ asset('front-assets/images/carousel-3.jpg') }}" />
                                ...
                                <div class="card-body text-center mt-3">
                                    ...
                                    <div class="price mt-2">
                                        ...
                                        @if ($product->compare_price > 0)
                                            <span class="h6 text-underline"><del>{{ number_format($product->compare_price, 2, ',', '.') }}
                                                    €</del></span>
                                        @endif
                                    </div>
                                </div>
