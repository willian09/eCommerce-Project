                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        @if ($product->compare_price > 0)
                            <h2 class="price text-secondary"><del>{{ number_format($product->compare_price, 2, ',', '.') }}
                                    €</del></h2>
                        @endif
                            ...
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    ...
                                    <div class="price mt-2">
                                        <span class="h5"><strong>{{ number_format($relProduct->price, 2, ',', '.') }}
                                                €</strong></span>
                                        @if ($relProduct->compare_price > 0)
                                            <span class="h6 text-underline"><del>{{ number_format($relProduct->compare_price, 2, ',', '.') }}
                                                    €</del></span>
                                        @endif
                                    </div>
                                </div>
